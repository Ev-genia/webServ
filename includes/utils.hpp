...
/*   Updated: 2023/02/07 14:03:42 by mlarra           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::string					getPage(const char *, std::string const &, int, Request &);
std::string					getLink(std::string const &, std::string const &, std::string const &, int, Request &);
